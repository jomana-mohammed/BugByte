...
$c_delete = new customer_controller(); 
$p = new person() ;
$p->id = $_POST['id'];
$p->email = $_POST['email'];
...
if (isset($_POST['id']) && isset($_POST['email']) && isset($_POST['password'])) {
  if ( ($p->id == $_SESSION["user_id"]) && ($c_delete->checkEmailPass($p)) )
   {

    if ($c_delete->deleteCust($p->id))
     {

      echo '<script type="text/javascript">
           window.onload = function() { alert ("Account deleted successfully"); }
           </script>';
      header("location:home.php");    

    } 
    else if ( ! ($c_delete->deleteCust($p->id)) )
     {

      echo '<script type="text/javascript">
           window.onload = function() { alert ("Account not deleted"); }
           </script>';
    }
    ...
    echo '<script type="text/javascript">
    window.onload = function() { alert ("you entered wrong information , please reenter them !"); }
    </script>';
    }
...
<nav class = "navv">
    <div class = "navnov">
        ...
        <ul>
            ...
            <li class="lii"><a href="delete_cust.php">Delete account</a></li>
        </ul>
    </div>
  </nav>
 <div class="bodyy"> 
  <div class="container">
      ...
      <form method="post">
         ...
         <div class="input-data">
            ...
            <div class="input-data">
               <input   required name="password" style="outline: none ; background-color:transparent;">
               <div class="underline"></div>

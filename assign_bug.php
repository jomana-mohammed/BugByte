...
$bug->staff_id = $_POST['staff_id'];
$bug->bug_id = $_POST['bug_id'];

if (isset($_POST['staff_id']) && isset($_POST['bug_id'])) {
  if (!empty($_POST['staff_id']) && !empty($_POST['bug_id']) ) {

    if ($adminController->assignBug($bug)) {

      echo '<script type="text/javascript">
           window.onload = function() { alert ("bug assigned successfully"); }
           </script>';

    } else if (!($adminController->assignBug($bug)) ) {
...
<nav class = "navv">
 ...
 <div class="bodyy"> 
  <div class="container">
      <div class="text">
         Assign bug to Staff member
      </div>
      <form method="post">
         <div class="form-row"> 
            <div class="input-data">
               <input required name="bug_id" style="outline: none  ; background-color:transparent; ">
               <div class="underline"></div>
               <label for="">Bug id</label>
            </div>
           <div class="input-data">
               <input  required name="staff_id" style="outline: none  ; background-color:transparent;" >
               <div class="underline"></div>
               <label for="">Staff id</label>
            </div>
           </div>   
            <div class="form-row submit-btn" style="margin-left:300px; margin-top:80px;">
               <div class="input-data">
                  <div class="inner"></div>
